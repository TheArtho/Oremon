...
export class BattleUiManager {
    static getBattleForm(battleInfo) {
    ...
    static getChoiceForm(battleInfo) {
    ...
    static UpdateBattleHud(player, battleInfo) {
        let str = "";
        str += `playerpanel:on:/:`;
        str += `opponentpanel:off:/:`;
