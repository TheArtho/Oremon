import {Vector3, Dimension, CameraSetRotOptions, CameraEaseOptions} from "@minecraft/server";
import {VectorUtils} from "../utils/VectorUtils";

export class BattleCameraManager {
    static BattleClassicCamera(
        playerPos: Vector3,
        opponentPos: Vector3,
        easeOption: CameraEaseOptions,
        dimension: Dimension
    ): CameraSetRotOptions {
        const center = VectorUtils.add(
            opponentPos,
